...
#define STATIC_SIZE_ASSERT(Type, ExpSize)	\
	enum { static_assert_sizeof_##Type##_ = sizeof(Type) };									\
	typedef ::Loki::Private::static_assert_test<sizeof(::Loki::Private::SizeError	\
		< (bool)( static_assert_sizeof_##Type##_ == ExpSize) >)> static_assert_typedef_
...
//
// Nov 16, 2011: fix macro STATIC_SIZE_ASSERT for compatiblity of VC6, by huaiyu
////////////////////////////////////////////////////////////////////////////////
